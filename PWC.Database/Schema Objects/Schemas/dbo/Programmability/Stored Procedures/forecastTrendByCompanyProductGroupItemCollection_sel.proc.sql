CREATE PROCEDURE [dbo].[forecastTrendByCompanyProductGroupItemCollection_sel]
...
SELECT DISTINCT
	...
	, factor_month_11
	, factor_month_12
FROM	ForecastTrendByCompanyProductGroup t
JOIN	Item i
...
AND	p.customer_number = @customer_number
ORDER BY 1, 2
