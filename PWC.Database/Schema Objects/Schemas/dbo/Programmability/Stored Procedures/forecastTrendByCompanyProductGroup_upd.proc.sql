...
CREATE PROCEDURE [dbo].[forecastTrendByCompanyProductGroup_upd]
	@objectKey xml
...
IF NOT EXISTS (SELECT 1 FROM ForecastTrendByCompanyProductGroup WHERE timestamp = @timestamp) BEGIN
...
UPDATE	ForecastTrendByCompanyProductGroup
